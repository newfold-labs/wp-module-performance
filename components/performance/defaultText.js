const defaultText = {
    ...
    cacheAdvancedSettingsTitle: __('Advanced settings', 'wp-module-performance'),
    cacheAdvancedSettingsDescription: __('Additional speed and scalability features powered by Jetpack Boost to make your site as fast as it can be.', 'wp-module-performance'),
